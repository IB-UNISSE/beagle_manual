...
**Apptainer** es una herramienta para ejecutar contenedores en ambientes de cómputo científico y clústeres HPC. En BEAGLE, Apptainer permite usar software bioinformático, filogenómico o científico sin instalarlo directamente en el sistema operativo del clúster y sin requerir permisos de administrador (`sudo`).

Un contenedor puede entenderse como un archivo que incluye un programa junto con muchas de sus dependencias. Esto permite ejecutar software de forma más controlada y reproducible, evitando conflictos con otros programas instalados en el sistema o con los ambientes de otros usuarios.

En BEAGLE, Apptainer es especialmente útil cuando:

-   el programa tiene muchas dependencias;

-   se necesita una versión específica de un software;

-   el software ya existe como imagen de contenedor;

-   se desea compartir un flujo de trabajo con otros usuarios;

-   se busca mayor reproducibilidad;

-   se ejecutarán análisis mediante Slurm.
